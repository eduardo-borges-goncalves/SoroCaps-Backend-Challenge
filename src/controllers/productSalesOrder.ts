...
// export const getProductsSalesOrders = async (req: Request, res: Response, next: NextFunction) => {
//     try {
...
// export const postProductsSalesOrder = async (req: Request, res: Response, next: NextFunction) => {
//     try {
